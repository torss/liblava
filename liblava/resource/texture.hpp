...
struct texture : id_obj {
  ...
  bool create(texture_init_info *init_info);
  void destroy();
...
texture::ptr load_texture(string_ref filename, texture_init_info *init_info);
...
struct texture_init_info {
  ...
  texture_init_info() {
    ...
    vk_sampler_create_info__init_base_alpha(sampler_info);
  }

  void set_layers_to_default() {
    static texture::layer::list default_layers = {};
