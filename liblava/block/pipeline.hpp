...
struct pipeline_layout : id_obj {
    ...
    void bind_descriptor_set(VkCommandBuffer cmd_buf, VkDescriptorSet descriptor_set, offset_list offsets = {}, VkPipelineBindPoint vkPipelineBindPoint = VK_PIPELINE_BIND_POINT_GRAPHICS);
    void bind(VkCommandBuffer cmd_buf, VkDescriptorSet descriptor_set, offset_list offsets = {}, VkPipelineBindPoint vkPipelineBindPoint = VK_PIPELINE_BIND_POINT_GRAPHICS) {

        bind_descriptor_set(cmd_buf, descriptor_set, offsets, vkPipelineBindPoint);
    }
